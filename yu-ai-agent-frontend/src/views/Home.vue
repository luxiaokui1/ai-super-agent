<template>
  <div class="home-container">
    <div class="header">
      ...
      <p class="subtitle">/ Explore the Power of AI /</p>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/love-master')">
        ...
        <div class="app-info">
          <div class="app-title">AI Love Advisor</div>
          <div class="app-desc">Your intelligent relationship counselor, powered by RAG knowledge base</div>
        </div>
      ...
      <div class="app-card" @click="navigateTo('/super-agent')">
        ...
        <div class="app-info">
          ...
          <div class="app-desc">Autonomous ReAct agent with web search, PDF generation and more</div>
        </div>
        <div class="app-button">
          <span class="btn-text">Try Now</span>
          <span class="btn-icon">→</span>
...
// 设置页面标题和元数据
useHead({
  title: 'AI Super Agent Platform',
  meta: [
    {
      name: 'description',
      content: 'AI Super Agent Platform featuring Love Advisor and autonomous Super Agent with tool-calling capabilities'
    },
    {
      name: 'keywords',
      content: 'AI Agent, Spring AI, RAG, ReAct Agent, Tool Calling, MCP, Love Advisor'
    }
  ]
})
